...
function Footer() {
  return (
    <>
      <div className="container mx-auto mt-16 px-4 border-t border-gray-300 shadow-2xl">
        <div className="footer w-full h-auto lg:h-[250px] mx-auto flex flex-col lg:flex-row justify-center items-center space-y-8 lg:space-y-0 lg:space-x-8 p-4 lg:p-8 rounded-sm">
          <div className="w-full lg:w-[206px] h-auto lg:h-[94.61px] lg:mr-16 flex justify-center lg:justify-start">
            <img src={imag1} alt="Logo" className="w-full h-full object-contain" />
          </div>
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="playstore mt-4 flex justify-center lg:justify-start">
              <img src={imag6} alt="Playstore" className="w-[159.28px] h-[111.21px]" />
            </div>
          </div>
        </div>
        <div className="div mx-10 md:pb-20">
          <p className="text-sm text-center">Travel & Tourism | Beauty | Job | Education | Food | Home & Decor | Fitness | Health | Real Estate | Banking | Finance | Shopping | Fitness | Health | Real Estate</p>
          <p className="text-sm text-center">Copyright @2008-2013. All rights reserved Privacy | Help | FAQs</p>
        </div>
      </div>
    </>
  );
